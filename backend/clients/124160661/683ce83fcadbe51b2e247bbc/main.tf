terraform {
  backend "http" {
    address        = "https://tidy-definitely-sailfish.ngrok-free.app/terraform/state/683ce83fcadbe51b2e247bbc"
    lock_address   = "https://tidy-definitely-sailfish.ngrok-free.app/terraform/lock/683ce83fcadbe51b2e247bbc"
    unlock_address = "https://tidy-definitely-sailfish.ngrok-free.app/terraform/unlock/683ce83fcadbe51b2e247bbc"
    lock_method    = "POST"
    unlock_method  = "POST"
  }
}
...
resource "aws_key_pair" "instance_key" {
  key_name   = "683ce83fcadbe51b2e247bbc-key"  # Key name will match instance name
...
resource "aws_security_group" "web_sg" {
  name = "683ce83fcadbe51b2e247bbc-sg"
